         ...
         <div className="container">
            <div className="vertical-layout">
               ...
               <div>
                  ...
                  <br />
                  <p>
                     I've been thinking up games since elementary school, back
                     when a friend and I put all our lucrative project ideas in
                     a red folder we labeled "
                     <font color="#db3d42">TOP SECRET</font>" with a cheap black
                     marker. Since then, I've been working tirelessly to improve
                     my skills with every idea, prototype, and project I've
                     worked on. That red folder is sadly long gone, but my
                     passion for making things is still very much alive.
                  </p>
                  {/* <p>
                  ...
                  <p className="text-center">
                     Gameplay Programming | Rapid Prototyping | Game Design | 3D
                     Modeling
                  </p>
                  <br />
