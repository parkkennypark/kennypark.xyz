...
const shortDescription = (
   <pre>
      A small, surreal action platformer about an angel trying to escape limbo.
      {"\n\n"}
...
const body = (
   <div>
      ...
      <pre>
         {"\n"}In this game, you play as an unnamed being who must defeat other
         angels in order to escape limbo.
         {"\n\n"}As the lead programmer, I was responsible for coding many of
         the main systems, including movement, interactions, dialogue, and boss
         behavior. Because they were both new to most of us, I also led the
         charge in learning Godot and Github, and kept communication flowing
         actively in our development Discord server.
         {"\n\n"}On the VFX side of things, one of my main goals for this
         project was to give it a distinct and cohesive visual identity. Apart
         from the resolution down-sampling, this was achieved through a fair
         amount of post processing, color correction, and other visual effects.
         I think the effort was well worth it, as the effects really add to the
         experience and make it that much more interesting.
         ...
         about pulling the newest changes from Github and seeing the game come
         to life through the combined effort of the team.
      ...
      <ul>
         <li>
            (Architecture) Signals are crucial to decouple systems, especially
