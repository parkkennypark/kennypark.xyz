...
const body = (
    <div>
      ...
      Blender"
        ...
        <pre>
            {"\n"}A carnival style shootout game where you fire ducks from a
            cannon to knock out pirates. The ducks can be customized with
            various hats/accessories, and Google Play leaderboard support allows
            users to compete for the highest score.
            {"\n\n"}The game supports both VR and traditional play.
            {"\n\n"}This was the first finished game I made with Unity. I was in
            the very early stages of learning scripting and design in general,
            and as such the game is pretty rough around the edges. It serves as
            a reminder of how much I've learned on all aspects of game creation.
        </pre>
    </div>
);
