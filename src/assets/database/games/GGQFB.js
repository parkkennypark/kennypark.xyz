        ...
        <Tabs>
            ...
            <TabPanel>
                <pre>
                    ...
                    />
                    {"\n"}Currently, the underlying systems are mostly in place.
                    This includes a smooth movement system, a fleshed out
                    dialogue system with a custom syntax/parser, a cut-scene
                    system, entity state machines, and combat. I've also
                    established an efficient model/texture creation workflow.
                    I'm now working hard on making the game's content.
            ...
            <TabPanel>
                <pre>
                    As this is primarily a platformer, I wanted Gura's moveset
                    to feel fluid and fast-paced. I also wanted platforming to
                    blend seamlessly with the combat aspects of the game, which
                    was the main motivation behind making the spin attack double
                    as a platforming move.
                    <Image
                        className="description-img"
                    ...
                    auto-targets platforming objects when performing a spin
                    attack. To match this fluidity of movement in combat, Gura
                    leaps towards targeted enemies automatically, similar to the
                    Batman: Arkham City games. This means that combat is less
                    about aiming/positioning than it is timing and dodging,
                    which fits the rest of the gameplay themes well.
                </pre>
            </TabPanel>
            {/* Enemy Behavior */}
            <TabPanel>
                <pre>
                    Though the combat in this game isn't complex, I wanted to
                    keep enemies from clumping up when targeting the player.
                    After some research, I took a lot of inspiration from this
                    video by GameEndeavor and how he went about implementing his
                    enemy's AI.
                    <Image
                        className="description-img"
                    ...
                    equally away from each other. Weights are then added to
                    these directions to decide which are favorable, and which
                    should be avoided. Directions towards the entity's target
                    are favorable, while directions towards other entities are
                    weighed negatively (to avoid clumping). These direction
                    vectors are then summed, resulting in the direction the
                    entity should move.
                    {"\n\n"}
                    I'm using a simple state machine setup for all the game's
                    entities, including Gura. There are two main states: Move
                    and Attack. Most other states inherit one of these classes.
                    There are also supplementary states such as PlayAnimation
                    and DoNothing, which both inherit the Move state.
                    {"\n\n"}
                    Chaining together these states with different exit
                    parameters allows for surprisingly interesting behavior from
                    this very simple implementation. Here is a sample enemy
                    behavior:
                    <Image
                        className="description-img"
            ...
            <TabPanel>
                <pre>
                    I coded a custom dialogue system for this project. The
                    system includes a custom syntax parser, portrait support,
                    and custom commands for various text effects, among other
                    things.
                    <Image
                        className="description-img"
                    ...
                    />
                    {"\n"}
                    Here is an example of how dialogue is formatted in a text
                    file.
                    <CodeComponent
                        plain={"true"}
                        language={"wiki"}
            ...
            <TabPanel>
                <pre>
                    ...
                    different camera states and positions - for example,
                    seamlessly transitioning from gameplay into a cutscene.
                    <Image
                        className="description-img"
                        src={projPath + "/screenshots/camera.mp4"}
                        autoVideo="true"
                    />
                    {"\n"}I implemented this using two scripts: a CameraBrain,
                    and CameraNodes. The CameraBrain controls the actual
                    camera's transformation as a singleton, and stores a target
                    CameraNode whose camera values it copies. CameraNodes store
                    transformation info as well as the smoothing speed when
                    transitioning to and from this node.
                    {"\n\n"}I'm using a stack to store the CameraNodes to switch
                    back and forth between cameras without a CameraNode to need
                    a reference to the previous CameraNode.
                </pre>
            </TabPanel>
            {/* Art Breakdown */}
            <TabPanel>
                It was important for me to establish a workflow that would allow
                me to make good looking environments efficiently.
                <Image
                    className="description-img"
                    src={projPath + "/screenshots/environments.png"}
                />
                To achieve this end, I layered various types of noise to create
                all the textures procedurally in Blender. I then export these
                seamless textures and import them into Godot for use.
                <Image
                    className="description-img"
