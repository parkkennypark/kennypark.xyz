...
const body = (
   <div>
      ...
      <pre>
         ...
         {"\n\n"}Levels are procedurally generated using a grid system. Pre-made
         rooms are spawned at random to fill sections of the grid, with doorways
         added between them afterwards. I also worked on the minimap, to help
         avoid players from getting lost.
         <Image
         ...
         took the lead on the visual design of the game. I knew we didn't have a
         lot of time to spend on art, so I opted for a look that uses simple
         geometry and heavy post processing to sell a foreboding aesthetic.
         <Image
            className="description-img"
