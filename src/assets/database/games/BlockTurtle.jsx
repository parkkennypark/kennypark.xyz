...
// const icon = "block_turtle_icon_630x500.png";
const icon = "Block Turtle icon 256x256 - Copy.png";
...
const body = (
   <div>
      ...
      <pre>
         ...
         and its little blocky protagonist. My late elementary school days were
         filled with goofy ideas for games like this that would eventually lead
         me to an even greater passion for making things. My natural skew
         towards silliness still shines through very clearly in all my projects.
         ...
         didn't learn the importance of backing up files until it was too late.
         I would love to play those dumb little games again.
         {"\n\n"}R.I.P. Block Turtle :(
      </pre>
   </div>
);
