...
const browserLink = "https://kennypark.itch.io/wreck-the-halls";
    ...
    <div>
      ...
      Blender"
        ...
        <ProjectProperty
            ...
            value={
                <>
                    ...
                    <ExternalLink link={browserLink} text="Browser" /> (original
                    jam ver.)
                </>
            }
        />
        ...
        <pre>
            ...
            was very broad: "Halloween." I made everything in the game, save the
            sfx and music. It won first place (of four projects), netting me a
            king-sized Kit Kat. I love Kit Kats, so I was pretty ecstatic.
            {"\n\n"}A couple months down the road, I took a some time to polish
