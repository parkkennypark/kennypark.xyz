...
const description = (
    <pre>
        ...
        Photoshop.
        {"\n\n"}Lamp modelled following a tutorial. The rest of the scene as
        well as the texturing and lighting was done independently by me. The
        lamp model can be viewed on{" "}
