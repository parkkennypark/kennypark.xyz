...
const description = (
  <pre>
    ...
    downloaded from Sketchfab, and they were laid out based on an illustration -
    credits are below.
  </pre>
);
...
const credits = (
  <pre className="p2">
    ...
    Attribution){"\n"}
    <ExternalLink link={laptop} text="Laptop" /> by VISIONNEW (CC Attribution)
    {"\n"}
    ...
    Attribution){"\n"}
    <ExternalLink link={boxes} text="Cardboard boxes" /> by Juan Carlos CR. (CC
    Attribution)
    {"\n"}
    ...
    Attribution){"\n"}
    <ExternalLink link={accessories} text="Various room accessories" /> by Matt
    Lemoine (CC Attribution Non-Commercial Share-A-Like){"\n"}
