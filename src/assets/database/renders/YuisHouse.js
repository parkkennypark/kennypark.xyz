...
const description = (
  <pre>
    ...
    {"\n\n"}This was a lighting project for a class. The house is from one of my
...
const credits = (
  <pre className="p2">
    Scene based on <ExternalLink link={illustLink} text="Yui's house" /> from
    the anime "K-On!"{"\n"}
    <ExternalLink link={toriGate} text="Tori gate" /> by Jasmine (CC Attribution
    Non-Commercial){"\n"}
